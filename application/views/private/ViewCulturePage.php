...
<body class="">
            ...
            <div class="card">
              <div class="card-header ">
                <div class="card-title ">
                  <h4 > Culture Page Table 
                  <a role="button" class="btn btn-sm btn-success b tn-round float-right" href="<?= base_url('UserC/LoadAddCulturePage')?>">
                  ...
                  <table class="table table-striped ">
                    ...
                    <?php foreach($UserData as $d):?>
                      ...
                      <td scope="row"> <?= $d->id ?></td>
                        ...
                        <td> <img src="<?= base_url('/assets/images/culturepage/').$d->img ?>"  width="200"> </td>
  ...
  <script>
        ...
        if (r==true)
        window.location = url+"UserC/RemoveCulturePage/"+id;
        else
          return false;
        } 
        ...
        if (r==true)
        window.location = url+"UserC/loadEditCulturePage/"+id;
        else
          return false;
        } 
